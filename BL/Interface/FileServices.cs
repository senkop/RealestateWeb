...
namespace Try.BL.Interface
{
    ...
    public class FileServices : IFileServices
    {
        public string AddFile(IFormFile file, string name)
        {
            ...
            {
                filepath = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), "Images", "ApartmentImages")).Root + $@"\{newFileName}";
            }
        ...
        public void DeleteFile(string file)
        {
            ...
            {
                filepath = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), "Images", "ApartmentImages")).Root + $@"\{file}";
            }
